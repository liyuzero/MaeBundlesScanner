...
package com.yu.mae.bundles.scanner.camera;
...
import com.yu.mae.bundles.scanner.config.Config;
...
final class CameraConfigurationManager {
    ...
    private static String findSettableValue(Collection<String> supportedValues,
        ...
        //Logger.i(TAG, "Supported values: " + supportedValues);
        String result = null;
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        //Logger.i(TAG, "Screen resolution: " + screenResolution);
    ...
    void setDesiredCameraParameters(Camera camera, boolean safeMode) {
        ...
        if (afterSize != null
           ...
           /* Logger.w(TAG, "Camera said it supported preview size "
    ...
    private Point findBestPreviewSizeValue(Camera.Parameters parameters,
        ...
        double screenAspectRatio = (double) screenResolution.y
        ...
        while (it.hasNext()) {
            ...
            if (maybeFlippedWidth == screenResolution.x
                ...
                /*Logger.i(TAG, "Found preview size exactly matching screen size: "
                        + exactPoint);*/
                return exactPoint;
            }
        }
        ...
        //Logger.i(TAG, "No suitable preview sizes, using default: " + defaultSize);
